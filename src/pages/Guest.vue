...
<template>
  <section class="relative overflow-hidden">
    <motion.div
      class="origin-left bg-primary fixed top-0 right-0 left-0 h-3"
      id="scrollIndicator"
    ...
    <motion.div
      :initial="{ y: -50, opacity: 0, delay: 5 }"
      :whileInView="{ y: 0, opacity: 1, delay: 5 }"
