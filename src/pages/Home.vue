...
<template>
  ...
  <div class="min-h-screen pt-2 bg-base-200">
    ...
    <div class="grid grid-cols-[1fr_4fr] gap-3">
      <!--sidebar-->
      <div class="bg-white w-full px-5 py-8 rounded-lg ring-1 ring-inset ring-base-300 h-full">
        <div>
          <!--Dashboard-->
          <div class="flex gap-4 items-center px-4 py-3 bg-base-300 hover:bg-base-300 rounded-lg cursor-pointer mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="size-6">
              <path stroke-linecap="round" stroke-linejoin="round"
          ...
          <!--Transactions-->
          <div class="flex gap-4 items-center px-4 py-3 hover:bg-base-300 rounded-lg cursor-pointer mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="size-6">
              <path stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="flex gap-4 items-center mt-8 px-4 py-3 hover:bg-base-300 rounded-lg cursor-pointer mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="size-6">
              <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 6h15M3 12h18M4.5 18h15" />
            </svg>
          ...
          <!-- Settings -->
          <div class="flex gap-4 items-center px-4 py-3 mt-10 hover:bg-base-300 rounded-lg cursor-pointer mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="size-6">
              <path stroke-linecap="round" stroke-linejoin="round"
